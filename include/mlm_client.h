/*  =========================================================================
    mlm_client - //  Send multipart string message to stream, end list with NULL
...
//  @warning Please edit the model at "api/mlm_client.xml" to make changes.
//  @interface
...
MLM_EXPORT int
    mlm_client_set_plain_auth (mlm_client_t *self, void args);
...
//  Returns >= 0 if successful, -1 if interrupted.                                  
MLM_EXPORT int
    mlm_client_connect (mlm_client_t *self, void args);
...
//  Returns >= 0 if successful, -1 if interrupted.                                  
MLM_EXPORT int
    mlm_client_set_producer (mlm_client_t *self, void args);
...
//  Returns >= 0 if successful, -1 if interrupted.                                  
MLM_EXPORT int
    mlm_client_set_consumer (mlm_client_t *self, void args);
...
//  Returns >= 0 if successful, -1 if interrupted.                                  
MLM_EXPORT int
    mlm_client_set_worker (mlm_client_t *self, void args);

//  *** Draft method, for development use, may change without warning ***
//  Send STREAM SEND message to server, takes ownership of message
//  and destroys message when done sending it.                    
MLM_EXPORT int
    mlm_client_send (mlm_client_t *self, void args);

//  *** Draft method, for development use, may change without warning ***
//  Send MAILBOX SEND message to server, takes ownership of message
//  and destroys message when done sending it.                     
MLM_EXPORT int
    mlm_client_sendto (mlm_client_t *self, void args);

//  *** Draft method, for development use, may change without warning ***
//  Send SERVICE SEND message to server, takes ownership of message
//  and destroys message when done sending it.                     
MLM_EXPORT int
    mlm_client_sendfor (mlm_client_t *self, void args);
