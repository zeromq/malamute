...
int main (int argc, char *argv [])
{
    ...
    zsock_send (broker, "ssi", "SET", "server/timeout", 2000);
    ...
    //  Allow client to connect, kill broker, restart broker
    puts ("Starting and running for 3 seconds...");
    sleep (3);
    puts ("Killing broker, pause 3 seconds...");
    zactor_destroy (&broker);
    sleep (3);
    puts ("Restarting broker, running for 3 seconds...");
