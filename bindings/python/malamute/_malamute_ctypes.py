...
lib.mlm_proto_recv.argtypes = [mlm_proto_p, czmq_master.zsock_p]
lib.mlm_proto_send.restype = c_int
lib.mlm_proto_send.argtypes = [mlm_proto_p, czmq_master.zsock_p]
lib.mlm_proto_print.restype = None
lib.mlm_proto_print.argtypes = [mlm_proto_p]
lib.mlm_proto_routing_id.restype = czmq_master.zframe_p
lib.mlm_proto_routing_id.argtypes = [mlm_proto_p]
lib.mlm_proto_set_routing_id.restype = None
lib.mlm_proto_set_routing_id.argtypes = [mlm_proto_p, czmq_master.zframe_p]
...
lib.mlm_proto_content.restype = czmq_master.zmsg_p
lib.mlm_proto_content.argtypes = [mlm_proto_p]
lib.mlm_proto_get_content.restype = czmq_master.zmsg_p
lib.mlm_proto_get_content.argtypes = [mlm_proto_p]
lib.mlm_proto_set_content.restype = None
lib.mlm_proto_set_content.argtypes = [mlm_proto_p, POINTER(czmq_master.zmsg_p)]
...
there was an error. Blocks if there is no message waiting.
    ...
    def routing_id(self):
        ...
        """
        return czmq_master.Zframe(lib.mlm_proto_routing_id(self._as_parameter_), False)
    ...
    def content(self):
        ...
        """
        return czmq_master.Zmsg(lib.mlm_proto_content(self._as_parameter_), False)

    def get_content(self):
        """
        Get the content field and transfer ownership to caller
        """
        return czmq_master.Zmsg(lib.mlm_proto_get_content(self._as_parameter_), False)

    def set_content(self, content_p):
        """

        """
        return lib.mlm_proto_set_content(self._as_parameter_, byref(czmq_master.zmsg_p.from_param(content_p)))
...
lib.mlm_client_actor.restype = czmq_master.zactor_p
lib.mlm_client_actor.argtypes = [mlm_client_p]
lib.mlm_client_msgpipe.restype = czmq_master.zsock_p
...
lib.mlm_client_send.argtypes = [mlm_client_p, c_char_p, POINTER(czmq_master.zmsg_p)]
lib.mlm_client_sendto.restype = c_int
lib.mlm_client_sendto.argtypes = [mlm_client_p, c_char_p, c_char_p, c_char_p, c_int, POINTER(czmq_master.zmsg_p)]
lib.mlm_client_sendfor.restype = c_int
lib.mlm_client_sendfor.argtypes = [mlm_client_p, c_char_p, c_char_p, c_char_p, c_int, POINTER(czmq_master.zmsg_p)]
lib.mlm_client_recv.restype = czmq_master.zmsg_p
...
lib.mlm_client_content.restype = czmq_master.zmsg_p
...
input sockets asynchronously.
        """
        return czmq_master.Zactor(lib.mlm_client_actor(self._as_parameter_), False)
...
is never ambiguous.
        """
        return czmq_master.Zsock(lib.mlm_client_msgpipe(self._as_parameter_), False)
...
and destroys message when done sending it.
        """
        return lib.mlm_client_send(self._as_parameter_, subject, byref(czmq_master.zmsg_p.from_param(content)))
...
and destroys message when done sending it.
        """
        return lib.mlm_client_sendto(self._as_parameter_, address, subject, tracker, timeout, byref(czmq_master.zmsg_p.from_param(content)))
...
and destroys message when done sending it.
        """
        return lib.mlm_client_sendfor(self._as_parameter_, address, subject, tracker, timeout, byref(czmq_master.zmsg_p.from_param(content)))

    def recv(self):
        """
        Receive message from server; caller destroys message when done
        """
        return czmq_master.Zmsg(lib.mlm_client_recv(self._as_parameter_), True)
    ...
    def content(self):
        ...
        """
        return czmq_master.Zmsg(lib.mlm_client_content(self._as_parameter_), False)
